...
interface MessAdminNavProps {
  messAdminName: string
  onLogout: () => void
}

export default function MessAdminNav({ messAdminName, onLogout }: MessAdminNavProps) {
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 px-3 py-2 bg-input rounded-lg">
              <span className="text-sm text-foreground">{messAdminName}</span>
            </div>
